...
//output, elements of a above the diagonal are destroyed. d[0..n] returns the eigenvalues 
//of a. v[0..n][0..n] is a matrix whose columns contain, on output, the normalized 
