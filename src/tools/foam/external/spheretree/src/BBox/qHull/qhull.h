...
struct qhT {
  ...
  int   OUTPUTINFOlevel;       /* 'Tn' conditional IStracing level */
  int   OUTPUTINFOpoint;       /* 'TPn' start tracing when point n is a vertex */
  realT OUTPUTINFOdist;        /* 'TWn' start tracing when merge distance too big */
  int   OUTPUTINFOmerge;       /* 'TMn' start tracing before this merge */
