...
ENVIRONMENT_HASHES = {
    "E0": "no_obstacles",
    "E1": "d96224ee",  # box_obstacle_spherized
    "E2": "38196ced",  # narrow_passage_spherized
    "E3": "3dab0f26",  # toroidal_wall_spherized
...
WAYPOINTS = {
    "E0": [
        [180.0, 90.0, 0.0],     # Origen / Home (Start)
        [-90.0, 135.0, 10.0],   # Waypoint #1
        [0.0, 90.0, -20.0],     # Waypoint #2
        [90.0, 120.0, 0.0],     # Waypoint #3
        [90.0, 120.0, 0.0],     # Waypoint #4
        [-180.0, 90.0, 0.0],    # Waypoint #5
        [180.0, 90.0, 0.0]      # Retorno al Origen
    ],

    "E1": [
        [180.0, 90.0, 0.0],     # Origen / Home (Caja)
        [-40.0, 90.0, 0.0],     # Waypoint #1
        [40.0, 90.0, 0.0],      # Waypoint #2
        [-180.0, 90.0, 0.0],    # Waypoint #3
        [180.0, 90.0, 0.0]      # Retorno al Origen
    ],

    "E2": [
        [180.0, 90.0, 0.0],     # Origen / Home (Pasaje estrecho)
        [-45.0, 70.0, -20.0],
        [0.0, 90.0, 0.0],
        [0.0, 110.0, 20.0],
        [30.0, 130.0, 40.0],
    ...
    "E3": [
        [180.0, 90.0, 0.0],     # Origen / Home (Cilindro vertical)
        [-45.0, 130.0, 20.0],   # Waypoint #1
        [60.0, 130.0, 20.0],    # Waypoint #2
        [180.0, 90.0, 0.0]      # Retorno al Origen
    ],
